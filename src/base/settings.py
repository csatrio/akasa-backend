...
EXCLUSION_DEBUG = [APP_MODULE_BASE, 'common', 'appuser', 'templates', 'administration', 'static', '.', 'media']
...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', '0.0.0.0', '172.16.143.112', '10.0.2.2', 'tracker-api']
